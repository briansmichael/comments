...
public class CommentValidator {
     ...
     */
    public CommentValidator(final DataService dService) {
     ...
     * @throws InvalidPayloadException when comment information is invalid
     */
    public void validate(final Comment comment) throws InvalidPayloadException {
        empty(comment);
    }

    /**
     * Ensures comment object is not null.
     *
     * @param comment Comment
     * @throws InvalidPayloadException when comment is null
     */
    private static void empty(final Comment comment) throws InvalidPayloadException {
        if (comment == null) {
            String msg = "No comment information was provided";
            log.warn(msg);
